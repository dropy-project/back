...
CREATE TABLE "User" (
    ...
    "lastSeenLocationLongitude" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "lastSeenLocationLatitude" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "Dropy" ADD CONSTRAINT "chatConversationId" FOREIGN KEY ("chatConversationId") REFERENCES "ChatConversation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
